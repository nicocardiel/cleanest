C------------------------------------------------------------------------------
C Version 22-August-2004                                       File: rpgbegin.f
C------------------------------------------------------------------------------
...
C
        IF(CBUT.EQ.'#')THEN
          ...
          CALL LRUNXBUTT(LRUN,LMANUAL,LHTML)
          IF(LRUN)THEN
            WRITE(*,101) 'y'
          END IF
          IF(LMANUAL)THEN
          ...
          END IF
          IF(LHTML)THEN
            WRITE(*,101) '<FONT COLOR="#FF0000">y</FONT>'
          END IF
        ELSE
          MODOTEXT_HTML=.FALSE.
